    ...
    public WavePayPaymentResponse paymentRequest(String orderId, String merchantReferenceId, Integer amount, String paymentDescription, List<Map<String, String>> itemList) {
        try {
            ...
            WavePayPaymentRequest request = new WavePayPaymentRequest(wavePayProperties.getMerchantId(), orderId, merchantReferenceId, wavePayProperties.getSuccessUrl(), wavePayProperties.getPaymentCallbackUrl()
                    , amount, wavePayProperties.getExpSeconds().toString(), paymentDescription, wavePayProperties.getMerchantName(), itemListStr, "");
            ...
            response.setAuthenticatedUrl(wavePayProperties.getPaymentRequestAuthenticateUrl(response.getTransactionId()));
