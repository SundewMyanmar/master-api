...
public class Sai2PayPaymentService {
	...
	public Sai2PayCheckPhResponse checkPhone(String phoneNo, String tokenString) {
	...
	public Sai2PayEnquiryPaymentResponse enquiryPayment(String invoiceNo, String sequenceNo, String amount,
		...
		Sai2PayEnquiryPaymentRequest request = new Sai2PayEnquiryPaymentRequest(uabProperties.getChannel(),
				...
				walletUserId, uabProperties.getEnquiryCallbackUrl(), paymentProperties.getExpiredSeconds(), "");
		request.setHashValue(securityManager.generateUABHashHmac(request.getSignatureString()));
