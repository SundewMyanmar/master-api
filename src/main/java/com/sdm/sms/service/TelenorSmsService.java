    ...
    private TelenorSmsMessage buildMessage(String content, String[] phones, MessageType msgType) {
        ...
        switch (msgType) {
            case TEXT:
                ...
                break;
            default:
                char[] chars = Hex.encodeHex(content.getBytes(StandardCharsets.UTF_16));
        ...
        for (String phone : phones) {
            receivers.add(this.buildMapData("@type", NameType.INTERNATIONAL.getValue(), "phoneNumber", phone));
        }
...
//        Globalizer.diffSeconds()
    ...
    public Map<String, String> sendMessage(TelenorSmsMessage message, TelenorTokenSetting setting) throws IOException {
        ...
        String testString = objectMapper.writeValueAsString(message);
